 ...
 uint32_t longitud = 5;
	int index=0;
		    ...
		    while(index<longitud)
		{
		 ...
		 vPrintString( "Presionar boton para realizar FUNCION 32to16 \r\n" );
    ...
    while( 1 )
    {
    	...
    	if( tecla_led_state == LED)
    	{
    		 ...
    		 //vPrintString( "Presionar boton para inicializar el vector a cero\r\n" );
    		        ...
    		        vPrintString( "INGRESO A LA FUNCION ASM_PACK32TO16 \r\n" );
...
int main( void )
{
  ...
  /* USER CODE BEGIN 2 */
	vPrintString( "Main: Ejercicio 06 -Language C - AdM.\r\n" );
